...
Основна частина коду реалізує ітераційну обробку даних із використанням циклу, який послідовно зчитує кожен CSV-файл і визначає цільові стовпці для часу та яскравості. Для кожного набору даних обчислюється середнє арифметичне значення яскравості та показник середньоквадратичного відхилення (шуму), які згодом округлюються і зберігаються у загальному списку результатів. Паралельно з розрахунками код виконує візуалізацію даних: створюється маска, після чого відфільтровані значення накладаються на графік для порівняльного аналізу. 

![PW_6_2.png](PW_6_2.png)

Після цього програма перетворює список накопичених результатів у таблицю summary_df, після чого отримує базове значення освітленості для «Контрольного запису» та розраховує відсоткову ефективність затемнення кожного матеріалу за математичною формулою поглинання світла.
